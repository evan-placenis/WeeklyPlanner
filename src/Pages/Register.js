...
function Register(){
    ...
    return(
        <div class = "flex flex-col items-center ">
            <h1 class = "text-3xl font-bold mt-10">Register</h1>
            <form required action="Register" method = "POST">
                <ul class="py-2 text-center mt-20">
                    <li class = "py-2">
                        <input required name = "username" type = "text" onChange={(e) => {setUsrName(e.target.value)}} placeholder = "Enter Username"/> 
                    </li>
                    <li class = "py-2">
                        <input required name = "password" type = "password" onChange={(e) => {setUsrPassword(e.target.value)}} placeholder = "Enter Password"/> 
                    </li>
                    <li class = 'py-2'>
                        <button type = "submit" onClick = {submit} class = "rounded-full bg-purple-500 text-white px-4 py-1 hover:bg-purple-700"> Register </button>
                    </li>
                </ul>
            </form>
        </div>
